...
class FeatureLayer(nn.Module):
    ...
    def __init__(self, layer_sizes, input_channel=3):
        ...
        # modified hyoseok
        self.conv1 = SpatioTemporalConv(input_channel, 64, (7, 3, 3), stride=(4, 2, 2), padding=(3, 1, 1),
                                        first_conv=True)
        ...
        self.conv2 = ResLayer(64, 64, (7,3,3), layer_sizes[0])
        self.conv3 = ResLayer(64, 128, (7,3,3), layer_sizes[1], downsample=True)
        self.conv4 = ResLayer(128, 256, (7,3,3), layer_sizes[2], downsample=True)
        self.conv5 = ResLayer(256, 512, (7,3,3), layer_sizes[3], downsample=True)
